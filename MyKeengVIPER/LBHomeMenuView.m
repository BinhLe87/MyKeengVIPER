...
@implementation LBHomeOverlayView
@end
...
@interface LBHomeMenuView() {
    
    LBHomeOverlayView *menuOverlayView;
    UIView *rootView;
    UIView *_contentView;
...
-(void)showMenuInView:(UIView *)view fromOwnerRect:(CGRect)fromOwnerRect {
    ...
    for (UIView *v in view.subviews) {
        ...
        if ([v isKindOfClass:[LBHomeOverlayView class]]) {
    ...
    menuOverlayView = [[LBHomeOverlayView alloc] initWithFrame:view.bounds];
...
-(UIView*)generateContentView {
    ...
    [_menuItems enumerateObjectsUsingBlock:^(LBHomeMenuItem * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
-(void)performAction:(id) sender {
    ...
    LBHomeMenuItem *menuItem = [_menuItems objectAtIndex:button.tag];
